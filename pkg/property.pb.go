...
type MatchPropertiesRequest_Filter struct {
	...
	// Фильтр по городу (для жёсткой фильтрации при матчинге)
...
const file_property_proto_rawDesc = "" +
	...
	"\x17PROPERTY_STATUS_DELETED\x10\x042\xa8\x06\n" +
	...
	"\x0fReindexProperty\x12'.leadexchange.v1.ReindexPropertyRequest\x1a(.leadexchange.v1.ReindexPropertyResponse\"/\x82\xd3\xe4\x93\x02):\x01*\"$/v1/properties/{property_id}/reindexB4Z2leadexchange/gen/go/leadexchange/v1;leadexchangev1b\x06proto3"
...
var file_property_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_property_proto_goTypes = []any{
	...
	(*ListPropertiesRequest_Filter)(nil),  // 14: leadexchange.v1.ListPropertiesRequest.Filter
	(*MatchPropertiesRequest_Filter)(nil), // 15: leadexchange.v1.MatchPropertiesRequest.Filter
}
var file_property_proto_depIdxs = []int32{
	...
	14, // 3: leadexchange.v1.ListPropertiesRequest.filter:type_name -> leadexchange.v1.ListPropertiesRequest.Filter
	...
	15, // 8: leadexchange.v1.MatchPropertiesRequest.filter:type_name -> leadexchange.v1.MatchPropertiesRequest.Filter
	...
	12, // 20: leadexchange.v1.PropertyService.ReindexProperty:input_type -> leadexchange.v1.ReindexPropertyRequest
	8,  // 21: leadexchange.v1.PropertyService.CreateProperty:output_type -> leadexchange.v1.PropertyResponse
	8,  // 22: leadexchange.v1.PropertyService.GetProperty:output_type -> leadexchange.v1.PropertyResponse
	6,  // 23: leadexchange.v1.PropertyService.ListProperties:output_type -> leadexchange.v1.ListPropertiesResponse
	8,  // 24: leadexchange.v1.PropertyService.UpdateProperty:output_type -> leadexchange.v1.PropertyResponse
	11, // 25: leadexchange.v1.PropertyService.MatchProperties:output_type -> leadexchange.v1.MatchPropertiesResponse
	13, // 26: leadexchange.v1.PropertyService.ReindexProperty:output_type -> leadexchange.v1.ReindexPropertyResponse
